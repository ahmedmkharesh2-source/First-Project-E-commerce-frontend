...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    const getProduct = async () => {
      try {
        const response = await axios.get(`https://first-project-e-commerce-backend-production.up.railway.app/api/v1/products/product-detail/${id}`);
  ...
  const updateProduct = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://first-project-e-commerce-backend-production.up.railway.app/api/v1/products/update-product/${id}`,
